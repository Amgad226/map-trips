-- AlterTable: Station (add coverImage)
...
INSERT INTO "new_Station" ("createdAt", "id", "latitude", "longitude", "name", "order", "tripId", "updatedAt")
SELECT "createdAt", "id", "latitude", "longitude", "name", "order", "tripId", "updatedAt" FROM "Station";
DROP TABLE "Station";
